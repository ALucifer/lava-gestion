...
console.log( 'Export PDF: Reading slider config [1/4]' );
...
probePage.open( inputFile, function( status ) {
	...
	if( config ) {
        ...
        console.log( 'Export PDF: Unable to read slider config. Make sure the input address points to a slider page.' );
        phantom.exit(1);
